...
var g4 = "foo" != "bar";
    ...
    auto a4 = script.symbol_table().get_variable("a4");
    auto a5 = script.symbol_table().get_variable("a5");
    auto a6 = script.symbol_table().get_variable("a6");
    ...
    auto b4 = script.symbol_table().get_variable("b4");
    auto b5 = script.symbol_table().get_variable("b5");
    auto b6 = script.symbol_table().get_variable("b6");
    auto c1 = script.symbol_table().get_variable("c1");
    auto c2 = script.symbol_table().get_variable("c2");
    auto c3 = script.symbol_table().get_variable("c3");
    auto c4 = script.symbol_table().get_variable("c4");
    auto c5 = script.symbol_table().get_variable("c5");
    auto c6 = script.symbol_table().get_variable("c6");
    ...
    auto d4 = script.symbol_table().get_variable("d4");
    auto d5 = script.symbol_table().get_variable("d5");
    auto d6 = script.symbol_table().get_variable("d6");
    ...
    auto f4 = script.symbol_table().get_variable("f4");
    auto g1 = script.symbol_table().get_variable("g1");
    auto g2 = script.symbol_table().get_variable("g2");
    auto g3 = script.symbol_table().get_variable("g3");
    auto g4 = script.symbol_table().get_variable("g4");
