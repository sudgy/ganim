...
TEST_CASE("Group bounding box", "[object]") {
    ...
    auto res1p1 = pga3_to_vga3(res1.get_inner_lower_left());
    auto res1p2 = pga3_to_vga3(res1.get_outer_upper_right());
    auto res2p1 = pga3_to_vga3(res2.get_inner_lower_left());
    auto res2p2 = pga3_to_vga3(res2.get_outer_upper_right());
    auto res3p1 = pga3_to_vga3(res3.get_inner_lower_left());
    auto res3p2 = pga3_to_vga3(res3.get_outer_upper_right());
    auto res4p1 = pga3_to_vga3(res4.get_inner_lower_left());
    auto res4p2 = pga3_to_vga3(res4.get_outer_upper_right());
    auto res5p1 = pga3_to_vga3(res5.get_inner_lower_left());
    auto res5p2 = pga3_to_vga3(res5.get_outer_upper_right());
    auto res6p1 = pga3_to_vga3(res6.get_inner_lower_left());
    auto res6p2 = pga3_to_vga3(res6.get_outer_upper_right());
