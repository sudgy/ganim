...
void bivectors()
{
    ...
    auto b2 = BivectorObject(e1 + 2*e2, 2*e1);
    ...
    auto path1 = std::vector<Vector>();
    for (int i = 0; i < 128; ++i) {
        path1.push_back(e1*ga_exp(e12*i*τ/128));
    }
    auto b3 = BivectorObject(path1);
