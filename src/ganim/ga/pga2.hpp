...
namespace ganim::pga2 {
    ...
    constexpr auto e0 = Vec(1, 0, 0);
    constexpr auto e1 = Vec(0, 1, 0);
    constexpr auto e2 = Vec(0, 0, 1);
    constexpr auto e01 = Bivec(1, 0, 0);
    constexpr auto e02 = Bivec(0, 1, 0);
    constexpr auto e12 = Bivec(0, 0, 1);
    constexpr auto e012 = Trivec(1);
